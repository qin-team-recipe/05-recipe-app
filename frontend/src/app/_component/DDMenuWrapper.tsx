...
export const baseDDMenu = tv({
  slots: {
    ...
    item: "cursor-pointer flex items-start gap-3 select-none rounded px-1 py-[6px] pl-2 text-sm text-mauve-11 outline-none hover:bg-mauve-3 hover:text-mauve-12",
